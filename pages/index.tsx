  ...
  return (
    <div className="bg-slate-400 py-20 px-10 grid gap-10 min-h-screen">
      <div className="bg-white p-6 rounded-3xl shadow-2xl">
        ...
        <button className="mt-5 bg-blue-500 text-white p-3 text-center rounded-xl w-2/4 mx-auto hover:bg-teal-600 hover:text-black active:bg-orange-500 focus:bg-pink-500">
          체크아웃
        </button>
      </div>
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-3 mb-5 flex justify-between items-center">
            <div className="space-x-2">
              <button className="h-5 w-5 rounded-full bg-yellow-500 focus:ring-2 ring-offset-2 ring-yellow-500"></button>
              <button className="h-5 w-5 rounded-full bg-blue-400"></button>
